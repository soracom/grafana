...
grep -Fq filerAdminUsers pkg/services/accesscontrol/resourcepermissions/api.go || { echo 'Source does not contain PR to FILTER USERS in the permission list!' ; exit 1; }