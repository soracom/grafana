...
func GetAvailableNotifiers() []*NotifierPlugin {
	...
	return []*NotifierPlugin{
		...
		},
		{
			Type:        "LINE",
			Name:        "LINE (EOL)",
			Description: "This channel is no longer available",
			Heading:     "",
			Alert: []string{
				"LINE Notify API は 2025 年 3 月 31 日に EOL を迎え、利用できなくなりました。別の連絡手段のご利用をご検討ください。",
				"LINE Notify API reached EOL on March 31, 2025 and is no longer available. Please consider using another contact point.",
